...
constexpr int DEFAULT_START_STATE  = 12345678;
constexpr int MAX_ALLOWED_CLASSES = 50;
...
namespace Platonic
{
    enum Dice : const int {E4D = 4, E6D = 6, E8D = 8, E12D = 12, E20D = 20};
}

constexpr int PLATONIC_SOLIDS[5] = {Platonic::Dice::E4D, Platonic::Dice::E6D, Platonic::Dice::E8D, Platonic::Dice::E12D, Platonic::Dice::E20D};
...
struct TDiceRoller
{
    ...
    int RollAndAdd() 
    {
        ...
        int Step = TDiceCount;
        while (int Step = 0; Step < TDiceCount ;)
        {
            int StepResult = Results[Step++];
...
union UHitDice
{
    UHitDice(Platonic::Dice HitDieShape, int Seed = DEFAULT_START_STATE)
    {
        switch (HitDieShape)
        {
            case Platonic::Dice::E4D:  Roller1d4  = DRoller1d4{Seed};  break;
            case Platonic::Dice::E6D:  Roller1d6  = DRoller1d6{Seed};  break;
            case Platonic::Dice::E8D:  Roller1d8  = DRoller1d8{Seed};  break;
            case Platonic::Dice::E12D: Roller1d12 = DRoller1d12{Seed}; break;
            case Platonic::Dice::E20D: Roller1d20 = DRoller1d20{Seed}; break;
        }          
    }
...
struct CharacterRace
{
    ...
    int RacialAbilityID = INVALID_INDEX;
...
{
private:
    DnDCharacter(const CharacterRace& InitRace, int ClassID, Character::Spec::StatType ClassPrimaryStat, Platonic::Dice HitDieShape, int Seed, int StartingGoldFactor = 10)
...
public:
    ...
    static DnDCharacter ConstructOnStack(bool& RaceAndClassWasCompatible, const CharacterRace& InitRace, int ClassID, Character::Spec::StatType ClassPrimaryStat, Platonic::Dice HitDieShape, int Seed)
    {
